class Query:
    ...
    query7="""
    SELECT CONCAT(Researcher.FirstName, ' ', Researcher.LastName) as ResearcherName, 
    COUNT(*) as ObservationCount, AVG(Habitat.Area) as AvgArea
    FROM ObservationRecord
    ...
    query8="""
    SELECT ConservationProgram.Name, COUNT(DISTINCT Researcher.ResearcherID) as ResearcherCount, 
    AVG(DATEDIFF(ConservationProgram.EndDate, ConservationProgram.StartDate)) as AvgProgramDuration
    FROM ConservationProgram
